...
export class Mapper005 extends Mapper {
  ...
  protected prgMode = 0  // 0=One 32KB, 1=Two 16KB, 2=One 16KB + two 8KB, 3=Four 8KB
  protected chrMode = 0  // 0=8KB pages, 1=4KB pages, 2=2KB pages, 3=1KB pages
  protected upperChrBit = 0
  protected irqHlineEnable = false
  protected irqHlineCompare = -1
  protected irqHlineCounter = -1
  protected irqLatch = 0
  protected ppuInFrame = false
